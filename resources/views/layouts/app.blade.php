        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between">
            ...
            <nav>
                <ul class="flex items-center justify-between font-bold text-sm text-white uppercase no-underline">
                    <li><a class="hover:text-gray-200 hover:underline px-4" href="{{ url('/') }}">Accueil</a></li>
                    <li><a class="hover:text-gray-200 hover:underline px-4" href="#">Page Facebook</a></li>
                    <li><a class="hover:text-gray-200 hover:underline px-4" href="#">A propos</a></li>
                    @guest
                        <li><a class="hover:text-gray-200 hover:underline px-4" href="{{ route('login') }}">{{ __('Login') }}</a></li>
                        @if (Route::has('register'))
                            <li><a class="hover:text-gray-200 hover:underline px-4" href="{{ route('register') }}">{{ __('Register') }}</a></li>
                        @endif
                    @else
                        <li>
                            <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                               class="hover:text-gray-200 hover:underline px-4" href="{{ route('logout') }}">
                                {{ __('Logout') }}</a>
                        </li>
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center py-12">
            ...
            <p class="text-lg text-gray-600">
                Mon blog personnel réalisé avec Laravel
            </p>
        </div>
    </header>
    ...
    <div id="app" class="container mx-auto flex flex-wrap py-6">
        ...
        <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
            <div class="w-full bg-white shadow flex flex-col my-4 p-6">
                ...
                <p class="pb-2">
                    Consultant et formateur Laravel. Développeur Web Full-Stack à mon compte depuis plusieurs années,
                    je collabore ainsi avec des entreprises de tailles variées dans le développement de leurs
                    applications Laravel (Formations, conseils, accompagnement, etc.).
                </p>
                <p class="pb-2">
                    J'ai notamment enseigné auprès de plus de 1 200 étudiants à travers le monde sur Udemy.
                </p>
                <a href="https://www.udemy.com/course/learn-laravel/?referralCode=306D65A19C0D49208899" class="w-full bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-2 py-3 mt-4">
                    Voir le cours Laravel
                </a>
            </div>
    ...
    <footer class="w-full border-t bg-white pb-12">
        ...
        <div class="w-full container mx-auto flex flex-col items-center">
            <div class="flex flex-col md:flex-row text-center md:text-left md:justify-between py-6">
                <a href="#" class="uppercase px-3">A propos</a>
                <a href="#" class="uppercase px-3">Politique de confidentialité</a>
                <a href="#" class="uppercase px-3">Conditions d'utilisations</a>
                <a href="#" class="uppercase px-3">Nous contacter</a>
            </div>
